 ...
 * @author Minh Hoang
 */
@WebServlet(name = "AscShoesController", urlPatterns = {"/AscShoesController"})
public class AscShoesController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ShoesDTO> listShoes = shoesDAO.getShoesASC();
            int count = listShoes.size();
            int endPage = count / 9;
            if (count % 9 != 0) {
                endPage++;
            }
            List<ShoesDTO> list = shoesDAO.pagingShoesASC(index);
