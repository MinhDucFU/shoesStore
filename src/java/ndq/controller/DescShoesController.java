 ...
 * @author Minh Hoang
 */
@WebServlet(name = "DescShoesController", urlPatterns = {"/DescShoesController"})
public class DescShoesController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        try {
            ...
            List<ShoesDTO> listShoes = shoesDAO.getShoesDESC();
            int count = listShoes.size();
            int endPage = count / 9;
            if (count % 9 != 0) {
                endPage++;
            }
            List<ShoesDTO> list = shoesDAO.pagingShoesDESC(index);
