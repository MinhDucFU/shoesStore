 ...
 * @author Minh Hoang
 */
@WebServlet(name = "SearchShoesByCategoryID", urlPatterns = {"/SearchShoesByCategoryID"})
public class SearchShoesByCategoryID extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<ShoesDTO> listShoes = shoesDAO.getShoesByCateID(cateID);
            ...
            if (listShoes != null) {
                ...
                List<ShoesDTO> list = shoesDAO.pagingShoesCate(index, cateID);
