 ...
 */
@MultipartConfig
public class UpdateShoesController extends HttpServlet {
        ...
        try {
            if (user == null) {
                ...
                if (statusUser.equals("Active")) {
                    ...
                    if (check) {
                        ShoesDTO shoes = new ShoesDTO(shoesID, shoesName, description, status, fileName, category, Float.parseFloat(price), Integer.parseInt(quantity));
                        shoesDAO.updateBook(shoes);
                        ...
                        ShoesDTO shoes = new ShoesDTO(shoesID, shoesName, description, status, fileName);
