...
public class UserDAO {
    ...
    public UserDTO checkLogin(String email, String password) throws SQLException, Exception {
        ...
        try {
            ...
            if (con != null) {
                String sql = "SELECT userID,fullName,password,roleID,phone,status,address "
                        + "FROM Users "
                ...
                if (rs.next()) {
                    ...
                    result = new UserDTO(email, name, password, roleID, status, phone, address);
    ...
    public boolean createUser(UserDTO user) throws Exception {
        ...
        try {
            con = DBHelper.getConnection();
            if (con != null) {
                String sql = "insert into Users(userID,fullName,password,roleID,status,phone,address) values(?,?,?,?,?,?,?)";
                ps = con.prepareStatement(sql);
